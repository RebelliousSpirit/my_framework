...
class Settings
{
    ...
    // 'teachers' - реальное название таблицы
    private $projectTables = [
        'teachers' => ['name' => 'учителя', 'img' => 'pages.png'],
        'students' => ['name' => 'ученики', 'img' => 'pages.png'],
    ];
    ...
    // Массив элементов которые лежат в его ячейке - это поля таблицы БД, при выводе данных которых будут использоватся,
